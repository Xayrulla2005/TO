  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Boshsahifa</h1>
          <p className="text-gray-500">Xush kelibsiz, {user?.fullName}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle>Songi savdolar</CardTitle>
            <CardDescription>POS boyicha oxirgi tranzaksiyalar</CardDescription>
          </CardHeader>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Tolov turi</TableHead>
